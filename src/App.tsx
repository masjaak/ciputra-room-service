...
export default function App() {
  ...
  const t = {
    EN: {
      ...
      successMsg:
        'Thank you! The kitchen at The Gallery is preparing your order.',
      back: 'Back to Home',
    ...
    ID: {
      ...
      successMsg:
        'Terima kasih! Dapur The Gallery sedang menyiapkan pesanan Anda.',
          ...
          <div className="flex justify-end mb-6">
            <div className="bg-black/30 backdrop-blur-md border border-white/20 px-3 py-1 rounded-full flex gap-3 text-[10px] font-medium text-white shadow-lg cursor-pointer hover:bg-black/40 transition-all">
              <span
                onClick={() => setLang('ID')}
                className={`${
                  lang === 'ID' ? 'text-white font-bold' : 'text-white/50'
                }`}
              >
                ID
              </span>
              ...
              <span
                onClick={() => setLang('EN')}
                className={`${
                  lang === 'EN' ? 'text-white font-bold' : 'text-white/50'
                }`}
              >
                EN
              </span>
              ...
              <div className="flex items-center gap-2 mb-1">
                <span
                  className={`w-2 h-2 rounded-full animate-pulse ${
                    hour >= 7 && hour <= 22 ? 'bg-green-500' : 'bg-red-500'
                  }`}
                ></span>
